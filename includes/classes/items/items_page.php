...
{       
    ...
    function get_tabs()
    {
        ...
        while($tabs = db_fetch_array($tabs_query))
        {
            ...
            {            
                $tabs_list[] = ['id'=>$tabs['id'],'name'=>$tabs['name'],'is_folder'=>$tabs['is_folder'],'parent_id'=>$tabs['parent_id'],'html'=>$html];
            }
            elseif($tabs['is_folder'])
            {
                $tabs_list[] = ['id'=>$tabs['id'],'name'=>$tabs['name'],'is_folder'=>$tabs['is_folder'],'parent_id'=>$tabs['parent_id'],'html'=>''];
            }
